...
const Cta = () => {
  ...
  return (
    <section className="min-h-[20rem] w-full max-w-[1440px] mx-auto px-4 py-8 flex items-center justify-center flex-col">
      ...
      <p className="text-center max-w-2xl text-2xl md:text">
      ...
      <Button className="mt-4 text-2xl md:text p-7 bg-blue-900 text-white hover:bg-blue-700 transition-colors" onClick={() => router.push('/contact')}>
        Contact Us
      </Button>
    </section>
  );
