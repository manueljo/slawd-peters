...
const WhatWeDo = () => {
    return(
        <section className='w-full max-w-[1440px] mx-auto px-4 py-8 flex items-center justify-around flex-col md:flex-row gap-10'>
            <div className="max-w-[500px]">
                <h2 className="text-3xl md:text-5xl font-bold">What We Do</h2>
                <p className="text-2xl md:text-md mt-4">
