...
const WhoWeAre = () => {
    return(
        <section className='w-full max-w-[1440px] mx-auto px-4 py-8 flex items-center justify-around flex-col-reverse md:flex-row gap-10'>
            <div>
            ...
            <div className="max-w-[500px]">
                ...
                <p className="text-2xl md:text mt-4">
